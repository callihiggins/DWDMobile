...
**Introduction:** Hello World Mobile Web, Client-Server, HTML/CSS, FTP/SFTP, and more  
...
*   [Week 2 Example](http://itp.nyu.edu/~ceh274/dwdmobile/week2/)  
...
**Assignment:**  
Fully build out the HTML for the structure of your app. Make your HTML/CSS Site Responsive with CSS Media Queries. If you haven't already done so, set up server space and host your app so that you can preview it on a device.  
...
*   **ITP DWD Spring 2013 Week 2 Notes:**  
    [http://itpwebclass.herokuapp.com/notes/week-2](http://itpwebclass.herokuapp.com/notes/week-2)
